...
export const UserEventDetails = () => {
    ...
    const handleBook = async (e) => {
        ...
        if (!stripe || !elements) {
            alert("Payment System not ready. Please try again in a few moments.");
            return;
        }

        // Get the CardElement and check if it's empty
        const cardElement = elements.getElement(CardElement);
        if (!cardElement._empty) { // Check if CardElement is not empty
            try {
            ...
            // Handle the specific case where the CardElement is empty
